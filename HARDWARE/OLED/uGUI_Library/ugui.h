...
#endif
#define DEFAULT_BACKCOLOR	C_BLACK
#define DEFAULT_FORECOLOR C_WHITE
...
void CX_InputUpdate(UG_U8 val);
void CX_DrawBattery(UG_S16 x0, UG_S16 y0,UG_U8 val);
...
/*Object functions*/
UG_OBJECT* CX_GetActiveObj(UG_WINDOW* wnd);
UG_OBJECT* CX_GetNextObj(UG_WINDOW* wnd);
UG_OBJECT* CX_GetPrevObj(UG_WINDOW* wnd);
UG_OBJECT* CX_GetFirstObj(UG_WINDOW* wnd);
UG_OBJECT* CX_GetFinalObj(UG_WINDOW* wnd);
void CX_FocusNextObj(UG_WINDOW* wnd);
void CX_FocusPrevObj(UG_WINDOW* wnd);
void CX_FocusFirstObj(UG_WINDOW* wnd);
void CX_FocusFinalObj(UG_WINDOW* wnd);
void CX_FocusObj(UG_WINDOW* wnd,UG_U8 pos);
...
UG_RESULT CX_TextboxToggleColor( UG_WINDOW* wnd, UG_U8 id);
UG_RESULT CX_TextboxResetColor( UG_WINDOW* wnd, UG_U8 id);
